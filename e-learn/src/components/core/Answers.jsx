...
//Answer is being checked for the classes
class Answers extends Component {
    ...
    //if answer is correct it will show right and if it is wrong
    checkAnswer(e) {
        ...
        if(!isAnswered) {
            ...
            //checking if answer is equal correct or not
            if(answer === correct){
    ...
    render() {
        ...
        //onclick is used to check the answer
        return (
            <div id="answers">
                <ul>
